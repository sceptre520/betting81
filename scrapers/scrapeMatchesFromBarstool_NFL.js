...
deleteOneSportsbookExtMatchesFromDB("Barstool");
...
var DK_comp_URL = `https://eu-offering.kambicdn.org/offering/v2018/pivusco/listView/${sportId}/${competitionId}.json?lang=en_US&market=US-CO`;
...
const MappedMatches = Promise.all([DKMatches, matchList]).then((values) => {
  ...
  for (let i = 0; i < DKEventMapping.length; i++) {
    ...
    DKEventMapping[i]["sportsbook"] = "Barstool";
  }
