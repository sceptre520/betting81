...
exports.scrapePBMarkets = async () => {
  ...
  return deleteOneSportsbookMarketsFromDB("PointsBet").then(() => {
    ////////////////////////////////////////////////////////////////////////////////
    ...
    const scrapedEventIDs = getPointsBetEventIDs(URL_for_events).then(
      (matches) => {
        //console.log(matches);
        return matches;
      }
    ...
    return Promise.resolve(PBEventMapping).then((PBEventMapping) => {
